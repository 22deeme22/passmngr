...
With this command, you remove an entry of your password manager, you have to specify the service.
...
With this command, you list every entry that is in your password manager.
...
With this command, you get the login and the password of the service specified.
...
With this command, you can change the password that you chose for your password manager.
